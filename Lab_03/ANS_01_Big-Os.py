...
'''
The time complexity of the above code is O(1) (constant time). 
...
'''
The time complexity of the above code is O(n^2), also known as quadratic. 
...
def runCase(size):
    ...
    #calls one of the functions depending on which one is enabled. 
    #constant(sequence)
